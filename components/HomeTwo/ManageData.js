            ...
            <div className="row align-items-center">
                ...
                <div className="col-lg-6 offset-lg-1 mt-5 mt-lg-0 col-12 ps-lg-5 pe-lg-5">
                    <div className="block-contents ms-xl-3">
                        ...
                        <p className="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">wallet is a simple software that allows you to run your business easily. One software tool brings success.</p>
