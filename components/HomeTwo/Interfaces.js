            ...
            <div className="row align-items-center">
                <div className="col-xl-6 col-12 pe-xl-5 mt-5 mt-xl-0 order-2 order-xl-1">
                    <div className="block-contents">
                        ...
                        <p className="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">wallet is a simple software that allows you to run your business easily. One software tool brings the whole business together.</p>
