								...
								<div className="about-us-widget">
									<Link href="/">
										<a className="footer-logo d-block">
											<img src="img/footer-logo.svg" alt="wallet" />
										</a>
									</Link>
									<p>
									Our app allows for easy, secure crypto trading and international money transfers. Trust us for the safest online money transfer services.
									</p>
								</div>
							</div>
						</div>
