				...
				<div className="row">
					...
					<div className="col-lg-4 col-md-6 col-12">
						<div className="features-card-item style-1">
							...
							<p>View daily transaction reports & analytics easily through wallet & improve business</p>
						</div>
					</div>
					<div className="col-lg-4 col-md-6 col-12">
						<div className="features-card-item style-1">
							...
							<p>Send and receive money at any time with maximum security through wallet app</p>
						</div>
					</div>
				</div>
			</div>
